...
<div class="container typewritter" style="padding-top: 30px;">
	...
	<p class="text-center">
		...
		<a class="btn btn-sm btn-danger" style="margin: 5px; " href="<?php echo base_url(); ?>pages/show">View</a> 
	</p><br>
	<h2 class="heading text-center" style="color: #333;">View CV</h2><br>

    
    <div class="container-fluid">
        <?php echo form_open('displays/show_data'); ?>
